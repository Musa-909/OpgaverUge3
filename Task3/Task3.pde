...
3.d In the Student class, add a constructor that takes 4 parameters with the names "tmpName", "tmpAge", "tmpIsFemale", "tmpDatamatikerTeam" and each with the same data types used for the instance variables in 3.c

3.e In the Student constructor, assign the values of the parameters to the instance variables created in 3.c.
...
3.g In the Teacher class, add a constructor that takes 3 parameters with the names "tmpName", "tmpAge", "tmpIsFemale" with the same datatypes used in 3.f
...
3.i Returning to the Datamatik tab, add a setup() function and in this method create a new object/instance of the type Teacher and give it the name, age and gender of your teacher.
