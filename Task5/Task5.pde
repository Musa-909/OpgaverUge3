...
For example, if both Students are on team "DAT1" or team "1" (depending on which data type you have used for the instance variable team), the method should return true. 
...
Make sure that you assign the return value to a variable in the setup() method.
